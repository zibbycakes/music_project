...
class MusicFormatter {
    ...
    formatDB()
    {
        var clean_entry = {track_title:'',album_title:'',album_thumbnail:'',artist_names:'',year:'',total_track:'',track_no:''};
        for(let entry of db.items) {
            //console.log(track);
            clean_entry = {track_title:'',album_title:'',album_thumbnail:'',artist_names:'',year:'',total_track:'',track_no:''};
            ...
            clean_entry.album_thumbnail = entry.track.album.images[0].url;
